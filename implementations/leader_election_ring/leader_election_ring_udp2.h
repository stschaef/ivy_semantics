...
class leader_election_ring_udp2 {
  public:
    ...
    virtual ~leader_election_ring_udp2();
	...
	udp_reader *trans__impl__rdr;
        ...
        leader_election_ring_udp2(unsigned me);
    virtual void imp__serv__elect();
    virtual void ext__trans__recv(unsigned v);
    virtual void ext__sec__timeout();
    virtual void __init();
    virtual void trans__impl__handle_recv(unsigned x);
    virtual void sec__impl__handle_timeout();
    virtual void ext__trans__send(unsigned dst, unsigned v);
    virtual void ext__serv__elect();
