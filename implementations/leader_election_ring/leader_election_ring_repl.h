...
class leader_election_ring_repl {
  public:
    ...
    virtual ~leader_election_ring_repl();
    ...
    bool _generating;
    unsigned asgn__pid[2];
    long long __CARD__id__t;
    long long __CARD__node__t;
    leader_election_ring_repl();
    virtual void imp__serv__elect(unsigned v);
    virtual void ext__app__async(unsigned me);
    virtual void ext__trans__recv(unsigned dst, unsigned v);
    virtual void ext__serv__elect(unsigned v);
    virtual void imp__trans__send(unsigned dst, unsigned v);
    virtual void ext__trans__send(unsigned dst, unsigned v);
    virtual unsigned ext__node__get_next(unsigned x);
    virtual void __init();
