...
void leader_election_ring_udp::install_thread(reader *r) {
    install_reader(r);
}

void leader_election_ring_udp::install_timer(timer *r) {
    #ifdef _WIN32
...
void leader_election_ring_udp::__tick(int __timeout){
}
